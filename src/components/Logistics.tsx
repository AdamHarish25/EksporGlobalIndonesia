  ...
  return (
    <section className="py-20 lg:py-24 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 rounded-[2rem] overflow-hidden ring-1 ring-white/10 bg-slate-800/40 shadow-2xl shadow-black/20">
          <div className="relative">
            <img src="/loadingPort.jpg" alt="Loading port and container terminal" className="h-[22rem] w-full object-cover" loading="lazy" />
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
              <div className="max-w-2xl">
                <div className="text-xs font-bold uppercase tracking-[0.18em] text-brand-300">Loading Ports</div>
                <h3 className="mt-2 text-2xl sm:text-3xl font-extrabold text-white">Tanjung Priok &amp; Belawan export gateways</h3>
                <p className="mt-3 text-sm sm:text-base text-slate-300 max-w-xl">
                  Port visuals reinforce that the shipment flow is real, structured, and ready for international distribution.
                </p>
              </div>
              <div className="flex flex-wrap gap-2">
                <span className="rounded-md bg-white/10 px-3 py-1.5 text-xs font-semibold text-brand-200 ring-1 ring-white/10 backdrop-blur-sm flex items-center gap-1.5">
                  <Compass size={12} /> Tanjung Priok
                </span>
                <span className="rounded-md bg-white/10 px-3 py-1.5 text-xs font-semibold text-brand-200 ring-1 ring-white/10 backdrop-blur-sm flex items-center gap-1.5">
                  <Compass size={12} /> Belawan
                </span>
              </div>
            </div>
          </div>
